...
export class Safe4337Pack extends RelayKitBasePack<{
   ...
   * @param {string[]} config.owners - The list of owner addresses for the Safe account.
   ...
   * @param {string} config.safeVersion - The Safe core contract version.
   * @param {string} config.safeModulesVersion - The Safe modules version.
   * @returns {string} The predicted Safe address (checksumed hex string).
   * @throws {Error} If Safe singleton, proxy factory, or module deployments are not available for the specified chain and versions.
   */
